...
class VetAuthLoginScreen extends StatefulWidget {
  const VetAuthLoginScreen({super.key});

  @override
  State<VetAuthLoginScreen> createState() => _VetAuthLoginScreenState();
}

class _VetAuthLoginScreenState extends State<VetAuthLoginScreen> {
  @override
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'login_as_vet'.tr(), // "Login" in Arabic, adjust as needed
                style: TextStyle(
