...
class SellerOtpScreen extends StatefulWidget {
  const SellerOtpScreen({super.key});

  @override
  State<SellerOtpScreen> createState() => _SellerOtpScreenState();
}

class _SellerOtpScreenState extends State<SellerOtpScreen> {
  @override
            ...
            Directionality(
              ...
              child: Pinput(
                ...
                focusedPinTheme: PinTheme(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(color: Color(0xFFF4A259), width: 1.5),
                    borderRadius: BorderRadius.circular(15),
                  ),
                ),
