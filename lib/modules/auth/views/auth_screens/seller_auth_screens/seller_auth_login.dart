...
class SellerAuthLoginScreen extends StatefulWidget {
  const SellerAuthLoginScreen({super.key});

  @override
  State<SellerAuthLoginScreen> createState() => _SellerAuthLoginScreenState();
}

class _SellerAuthLoginScreenState extends State<SellerAuthLoginScreen> {
  @override
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'login_as_seller'.tr(), // "Login" in Arabic, adjust as needed
                style: TextStyle(
