          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemCount:
                    3, // Example count, replace with your categories length
                itemBuilder: (context, index) {
                  // Example data, replace with your actual data
                  final List<Map<String, String>> categories = [
                    {'title': 'Dogs', 'image': 'assets/images/dog.png'},
                    {'title': 'Cats', 'image': 'assets/images/cat.png'},
                    {'title': 'Birds', 'image': 'assets/images/bird.png'},
                  ];

                  return GestureDetector(
                    onTap: () {
                      NavigationService().pushWidget(
                        CategoryScreen(categoryName: 'أطعمة'),
                      );
                    },
                    child: Container(
                      width: 110,
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      NavigationService().pushWidget(
                        ProductDetailsScreen(product: null),
                      );
                    },
                    child: Container(
                      width: 156,
